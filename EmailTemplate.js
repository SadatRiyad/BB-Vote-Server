const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          <div class="header">Verify Your Email with Given OTP</div>
          <div class="content">
              <p>Hello, Welcome to BB-Vote!</p>
              <p>Thank you for signing up! <br/>Please confirm your email address by entering the code below:</p>
              <span class="verification-code">{otp}</span>
              <p>This OTP will expire in 5 minutes! Please verify your email within this time.</p>
              <p>If you did not create an account, no further action is required. If you have any questions, feel free to contact our support team.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} BB-Vote. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
